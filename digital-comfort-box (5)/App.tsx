    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden font-sans text-slate-700 bg-slate-50">
      ...
      <main className={`relative z-10 w-full max-w-2xl px-6 py-8 transition-all duration-500 ease-in-out ${isTransitioning ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
        ...
        {!selectedMood ? (
          ...
          // MESSAGE VIEW
          <CardGlass className="p-8 md:p-16 min-h-[500px] flex flex-col items-center justify-center text-center">
            ...
            {loading ? (
              ...
              <div className="w-full animate-fade-in relative">
                 <button 
                    onClick={handleReset}
                    className="absolute top-0 left-0 md:top-0 md:left-0 text-slate-400 hover:text-lavender-600 transition-colors p-2 rounded-full hover:bg-white/50"
                    aria-label="Back"
                  >
